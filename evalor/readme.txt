...
Tags: evalor, sidebar, review, reviews, woocommerce, webwinkel, keur, keurmerk, waardering
...
Deze module integreert de eValor sidebar in uw WordPress website of WooCommerce webshop.

== Description ==

De WordPress module zorgt voor een eenvoudige integratie van het eValor
binnen jouw WordPress website en WooCommerce webwinkel. Zo integreert de module
automatisch de innovatieve [eValor Sidebar][1] binnen elke WordPress
...
1. Plaats de map "evalor" in de map "wp-content/plugins" op de webserver.
1. De plugin kan nu worden geactiveerd in de administratieinterface. Ga daarvoor naar Plugins en klik op Activeren bij de eValor plugin.
